...
public class Mid extends SequentialCommandGroup {
  ...
  public Mid(Extender extenderSusbsystem, Elevator elevatorSubsystem, Wrist wristSubsystem) {
    ...
    addCommands(
      new MidElevator(m_Elevator).withTimeout(1),
        new ParallelCommandGroup(
          new MidExtender(m_Extender),
          new MidWrist(m_Wrist)
        )
    );
  }
}
