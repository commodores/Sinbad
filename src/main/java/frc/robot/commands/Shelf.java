...
public class Shelf extends SequentialCommandGroup {
  ...
  public Shelf(Extender extenderSusbsystem, Elevator elevatorSubsystem, Wrist wristSubsystem) {
    ...
    addCommands(
      new ShelfElevator(m_Elevator).withTimeout(1),
        new ParallelCommandGroup(
          new ShelfExtender(m_Extender),
          new ShelfWrist(m_Wrist)
        )
    );
  }
}
